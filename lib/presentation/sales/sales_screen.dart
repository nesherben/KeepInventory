                  ...
                  builder: (BuildContext context, ScrollController scrollController) {
                    return Container(
                      ...
                      child: ClipRRect(
                        ...
                        child: Stack(
                          children: [
                            // 1. LA LISTA SCROLLEABLE (Ocupa todo el fondo)
                            ListView.builder(
                              controller: scrollController,
                              // Estos paddings son clave: dejan hueco para que la lista no se esconda
                              // debajo de la cabecera fija ni del botón inferior
                              padding: EdgeInsets.only(
                                top: 75,
                                bottom: _cart.isNotEmpty ? 90 : 20,
                              ),
                            ...
                            // 2. LA CABECERA FIJA (Arriba del todo)
                            Positioned(
                              top: 0,
                              left: 0,
                              right: 0,
                              // IgnorePointer hace que si tocas aquí, el gesto pase a la lista de fondo
                              child: IgnorePointer(
                                child: Container(
                                  color: Colors.white,
                                  child: Column(
                            ...
                            // 3. EL BOTÓN DE COBRAR FIJO (Abajo del todo)
                            if (_cart.isNotEmpty)
                              Positioned(
                                bottom: 0,
                                left: 0,
